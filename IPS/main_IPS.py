...
from model_IPS import BPR, train, valid, test
#%%
'''ARGPARSER'''
...
model = BPR(num_users= num_users, num_items = num_items, embedding_size = embedding_size, blen_pop = blen_pop, device = device)
...
best_model_path = "IPS_best_model.pth"
#%%
